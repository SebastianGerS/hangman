...
var overrideDisable = function overrideDisable() {
    for (var q = 0; q < letterButtons.length; q++) {
        if (!letterButtons[q].classList.contains('override')) letterButtons[q].classList.add('override');else {
...
var Timer = function Timer(timer, ms, s, m) {
    ...
    this.increment = function () {
        ...
        _this.timer.innerHTML = 'Time: ' + _this.getMinutes() + ':' + _this.getSeconds() + ':' + _this.getMilliSeconds();
    };
